...
describe('/auto-fix command prompt', () => {
  test('points project and local settings at canonical .openairllm paths', async () => {
    ...
    expect(text).toContain('.openairllm/settings.json')
    expect(text).toContain('.openairllm/settings.local.json')
