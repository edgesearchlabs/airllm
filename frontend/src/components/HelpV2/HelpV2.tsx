...
export function HelpV2(t0) {
  ...
  if ($[31] !== publicBuildVersion || $[32] !== tabs) {
    t6 = <Tabs title={false ? "/help" : `OpenAirLLM v${publicBuildVersion}`} color="professionalBlue" defaultTab="general">{tabs}</Tabs>;
  ...
  if ($[34] === Symbol.for("react.memo_cache_sentinel")) {
    t7 = <Box marginTop={1}><Text>For more help:{" "}<Link url="https://github.com/Gitlawb/openairllm" /></Text></Box>;
    $[34] = t7;
  } else {
    t7 = $[34];
  }
