...
export function createProjectOnboardingFeed(steps: Step[]): FeedConfig {
  ...
  const warningText = getCwd() === homedir() ? 'Note: You have launched openairllm in your home directory. For the best experience, launch it in a project directory instead.' : undefined;
  if (warningText) {
    lines.push({
      text: warningText
    });
...
export function createGuestPassesFeed(): FeedConfig {
  ...
  const subtitle = reward ? `Share OpenAirLLM and earn ${formatCreditAmount(reward)} of extra usage` : 'Share OpenAirLLM with friends';
  return {
