...
export type Props = {
   ...
   * project-scoped (written to the assistant's .openairllm/settings.json via
   * install.ts) and should not leak to the user's global ~/.openairllm/settings.json.
   */
...
export function ModelPicker(t0) {
  ...
  const t16 = headerText ?? "Switch between Claude models. Applies to this session and future OpenAirLLM sessions. For other/previous model names, specify with --model.";
  let t17;
  if ($[42] !== t16) {
