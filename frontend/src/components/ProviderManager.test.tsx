...
test('ProviderManager first-run Codex OAuth switches the current session after login completes', async () => {
  ...
  expect(onDone).toHaveBeenCalledWith(
    expect.objectContaining({
      action: 'saved',
      message:
        'Codex OAuth configured. OpenAirLLM switched to it for this session.',
    }),
  )
...
test('ProviderManager first-run Codex OAuth surfaces credential storage warnings', async () => {
  ...
  expect(onDone).toHaveBeenCalledWith(
    expect.objectContaining({
      action: 'saved',
      message:
        'Codex OAuth configured. OpenAirLLM switched to it for this session with warnings: Warning: Storing credentials in plaintext.',
    }),
  )
