...
// '.claude/...' and drifted from the canonical '.openairllm/...'.
//
...
//      literal '.openairllm/...' (catches a settings.ts regression).
...
const EXPECTED = {
  projectSettings: '.openairllm/settings.json',
  localSettings: '.openairllm/settings.local.json',
} as const
...
test('getRelativeSettingsFilePathForSource returns the canonical .openairllm/ paths', () => {
