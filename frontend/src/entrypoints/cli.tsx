...
// unexpectedly absent. OpenAirLLM's supported runtime is Node >=22; this is
...
// OpenAirLLM: disable experimental API betas by default.
...
export async function main(
  ...
  if (args.length === 1 && (args[0] === '--version' || args[0] === '-v' || args[0] === '-V')) {
    ...
    console.log(`${MACRO.DISPLAY_VERSION ?? MACRO.VERSION} (OpenAirLLM)`);
    return;
  }

  // Fast-path for `openairllm ps|logs|attach|kill`.
