...
const PROTO_PATH = path.resolve(import.meta.dirname, '../proto/openairllm.proto')
...
const openairllmProto = protoDescriptor.openairllm.v1
...
export class GrpcServer {
  ...
  constructor() {
    ...
    this.server.addService(openairllmProto.AgentService.service, {
      ...
      try {
        if (clientMessage.request) {
          ...
          engine = new QueryEngine({
            ...
            mcpClients: [],
            // Register OpenAirLLM's built-in agents (general-purpose,
