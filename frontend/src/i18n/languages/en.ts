export const en = {
  ...
  'commands.doctor.description':
    'Diagnose and verify your OpenAirLLM installation and settings',
  ...
  'commands.insights.description':
    'Generate a report analyzing your OpenAirLLM sessions',
  ...
  'commands.plugin.description': 'Manage OpenAirLLM plugins',
  ...
  'commands.stats.description':
    'Show your OpenAirLLM usage statistics and activity',
  'commands.status.description':
    'Show OpenAirLLM status including version, model, account, API connectivity, and tool statuses',
  'commands.statusline.description': "Set up OpenAirLLM's status line UI",
  'commands.stickers.description': 'Order OpenAirLLM stickers',
  ...
  'commands.wiki.description':
    'Initialize and inspect the OpenAirLLM project wiki',
