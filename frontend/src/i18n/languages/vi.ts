export const vi = {
  ...
  'commands.doctor.description':
    'Chẩn đoán và xác minh cài đặt OpenAirLLM',
  ...
  'commands.insights.description':
    'Tạo báo cáo phân tích các phiên OpenAirLLM',
  ...
  'commands.plugin.description': 'Quản lý plugin OpenAirLLM',
  ...
  'commands.stats.description':
    'Hiện thống kê sử dụng và hoạt động OpenAirLLM',
  'commands.status.description':
    'Hiển thị trạng thái OpenAirLLM bao gồm phiên bản, mô hình, tài khoản, kết nối API và trạng thái công cụ',
  'commands.statusline.description':
    'Thiết lập giao diện dòng trạng thái của OpenAirLLM',
  'commands.stickers.description': 'Đặt mua sticker OpenAirLLM',
  ...
  'commands.wiki.description':
    'Khởi tạo và kiểm tra wiki dự án OpenAirLLM',
