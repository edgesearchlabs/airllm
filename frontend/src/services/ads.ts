 ...
 *
 * openairllm shows opt-in "sponsored tips" during inference waits; a viewer who
 ...
 * stored in openairllm config), sent as the `x-earn-code` header.
 *
...
const COMMON_HEADERS = (earnCode: string): Record<string, string> => ({
  ...
  'user-agent': 'gitlawb-openairllm-ads',
