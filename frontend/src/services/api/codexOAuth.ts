...
<html lang="en">
  ...
  <body>
    ...
    <p>You can return to OpenAirLLM now.</p>
    <p>OpenAirLLM will finish activating your new Codex OAuth login.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>${safeMessage}</p>
    <p>You can close this window and try again in OpenAirLLM.</p>
  </body>
</html>`
}
...
<html lang="en">
  ...
  <body>
    ...
    <p>You can close this window and retry in OpenAirLLM.</p>
  </body>
</html>`
}
