 ...
 * (e.g. "@edgesearch/openairllm@latest") with the given package manager.
 */
export function getGlobalInstallArgs(
  ...
  switch (pm) {
    ...
    case 'yarn':
      ...
      // for the documented openairllm install path.
...
/**
 * Detect which package manager owns the currently running OpenAirLLM install.
 *
 * Strategy:
