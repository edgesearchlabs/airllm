...
export function checkSupportedNodeVersion(
  ...
  if (major === null) {
    return {
      ...
      version,
      major,
      message: `Could not parse Node.js version: ${version}. OpenAirLLM requires Node.js ${MIN_NODE_ENGINE_RANGE}.`,
    }
  }
  ...
  if (major < MIN_NODE_MAJOR) {
    return {
      ...
      version,
      major,
      message: `Detected ${version}. OpenAirLLM requires Node.js ${MIN_NODE_ENGINE_RANGE}. Install Node ${MIN_NODE_MAJOR} LTS or newer, then reinstall/re-run OpenAirLLM.`,
    }
  }
