 ...
 *
 * Usage:
 *   openairllm --provider openai --model gpt-4o
 *   openairllm --provider gemini --model gemini-2.0-flash
 *   openairllm --provider mistral --model ministral-3b-latest
 *   openairllm --provider ollama --model llama3.2
 *   openairllm --provider anthropic   (default, no-op)
 */
 ...
 *
 * Issue #808: `openairllm --model <name>` should work standalone so users can
