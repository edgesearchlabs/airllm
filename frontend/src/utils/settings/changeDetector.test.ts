...
const pathsBySource: Record<SettingSource, string | null> = {
  userSettings: normalize('/tmp/openairllm/user/settings.json'),
  projectSettings: normalize('/tmp/openairllm/project/.openairllm/settings.json'),
  localSettings: normalize('/tmp/openairllm/project/.openairllm/settings.local.json'),
  flagSettings: null,
  policySettings: normalize('/tmp/openairllm/managed/managed-settings.json'),
}
...
async function importFreshModule(): Promise<SettingsChangeDetectorModule> {
  ...
  activeDetector._setDependenciesForTesting({
    ...
    getManagedSettingsDropInDir: () =>
      normalize('/tmp/openairllm/managed/managed-settings.d'),
