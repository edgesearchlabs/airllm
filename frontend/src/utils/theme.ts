...
export type Theme = {
  ...
  // OpenAirLLM brand accent (gitlawb orange). Values MUST be rgb() strings in
...
const darkTheme: Theme = {
  ...
  claude: 'rgb(255,122,26)', // OpenAirLLM brand orange
  claudeShimmer: 'rgb(255,177,95)', // Lighter brand orange for shimmer effect
  brand: 'rgb(255,122,26)', // OpenAirLLM brand orange
